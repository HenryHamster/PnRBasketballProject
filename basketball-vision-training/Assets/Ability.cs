...
public class Ability : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Rec2.GetComponent<Renderer>().material.color = new Color(0f, 0.6f, 0.8f);
        Rec3.GetComponent<Renderer>().material.color = new Color(0f, 0.6f, 0.8f);
